...
**Note:** this is the "per-architecture" repository for the `riscv64` builds of [the `gazebo` official image](https://hub.docker.com/_/gazebo) -- for more information, see ["Architectures other than amd64?" in the official images documentation](https://github.com/docker-library/official-images#architectures-other-than-amd64) and ["An image's source changed in Git, now what?" in the official images FAQ](https://github.com/docker-library/faq#an-images-source-changed-in-git-now-what).
...
[![riscv64/gazebo build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/riscv64/job/gazebo.svg?label=riscv64/gazebo%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/riscv64/job/gazebo/)
...
```console
$ docker run -v "/home/ubuntu/.gazebo/:/root/.gazebo/" riscv64/gazebo
```
...
```console
$ docker run -d -v="/tmp/.gazebo/:/root/.gazebo/" --name=gazebo riscv64/gazebo
```
...
```console
$ docker exec -it riscv64/gazebo bash
