...
```console
$ docker run -d --name some-ghost -e NODE_ENV=development i386/ghost
```
...
```console
$ docker run -d --name some-ghost -e NODE_ENV=development -e url=http://localhost:3001 -p 3001:2368 i386/ghost
```
...
```console
$ docker run -d --name some-ghost -e NODE_ENV=development -p 3001:2368 -v /path/to/ghost/blog:/var/lib/ghost/content i386/ghost:alpine
```
...
```console
$ docker run -d --name some-ghost -e NODE_ENV=development -v some-ghost-data:/var/lib/ghost/content i386/ghost
```
...
```console
$ docker run -d --name some-ghost -e NODE_ENV=development -e url=http://some-ghost.example.com i386/ghost
```
