...
[![mips64le/kapacitor build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/mips64le/job/kapacitor.svg?label=mips64le/kapacitor%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/mips64le/job/kapacitor/)
...
```console
$ docker run -p 9092:9092 mips64le/kapacitor
```
...
```console
$ docker run --rm mips64le/kapacitor kapacitord config > kapacitor.conf
```
...
```console
$ docker run --name=kapacitor -d -p 9092:9092 mips64le/kapacitor
```
