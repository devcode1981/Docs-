...
[![riscv64/nextcloud build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/riscv64/job/nextcloud.svg?label=riscv64/nextcloud%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/riscv64/job/nextcloud/)
...
```console
$ docker run -d -p 8080:80 riscv64/nextcloud
```
...
```console
$ docker run -d riscv64/nextcloud:fpm
```
...
```console
$ docker pull riscv64/nextcloud
$ docker stop <your_nextcloud_container>
$ docker rm <your_nextcloud_container>
$ docker run <OPTIONS> -d riscv64/nextcloud
```
