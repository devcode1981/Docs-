...
**Note:** this is the "per-architecture" repository for the `riscv64` builds of [the `r-base` official image](https://hub.docker.com/_/r-base) -- for more information, see ["Architectures other than amd64?" in the official images documentation](https://github.com/docker-library/official-images#architectures-other-than-amd64) and ["An image's source changed in Git, now what?" in the official images FAQ](https://github.com/docker-library/faq#an-images-source-changed-in-git-now-what).
...
[![riscv64/r-base build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/riscv64/job/r-base.svg?label=riscv64/r-base%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/riscv64/job/r-base/)
...
```console
$ docker run -ti --rm riscv64/r-base
```
...
```console
$ docker run -ti --rm -v "$PWD":/home/docker -w /home/docker -u docker riscv64/r-base R CMD check .
```
...
```console
$ docker run -ti --rm riscv64/r-base bash
$ vim.tiny myscript.R
```
