...
The `arm64v8/rethinkdb` images come in many flavors, each designed for a specific use case.

## `arm64v8/rethinkdb:<version>`
...
## `arm64v8/rethinkdb:<version>-slim`

This image does not contain the common packages contained in the default tag and only contains the minimal packages needed to run `arm64v8/rethinkdb`. Unless you are working in an environment where *only* the `arm64v8/rethinkdb` image will be deployed and you have space constraints, we highly recommend using the default image of this repository.
