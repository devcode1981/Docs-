...
The `s390x/rethinkdb` images come in many flavors, each designed for a specific use case.

## `s390x/rethinkdb:<version>`
...
## `s390x/rethinkdb:<version>-slim`

This image does not contain the common packages contained in the default tag and only contains the minimal packages needed to run `s390x/rethinkdb`. Unless you are working in an environment where *only* the `s390x/rethinkdb` image will be deployed and you have space constraints, we highly recommend using the default image of this repository.
