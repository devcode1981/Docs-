...
**Note:** this is the "per-architecture" repository for the `ppc64le` builds of [the `teamspeak` official image](https://hub.docker.com/_/teamspeak) -- for more information, see ["Architectures other than amd64?" in the official images documentation](https://github.com/docker-library/official-images#architectures-other-than-amd64) and ["An image's source changed in Git, now what?" in the official images FAQ](https://github.com/docker-library/faq#an-images-source-changed-in-git-now-what).
