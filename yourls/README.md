...
## Start a `arm64v8/yourls` server instance
...
```console
$ docker run --name some-yourls -e YOURLS_DB_PASS_FILE=/run/secrets/mysql-root ... -d arm64v8/yourls:tag
```
